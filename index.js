    ...
    fetch(url)
        ...
        .then(data => {
            ...
            switch (data.results.forecast[0].rain_probability) {
                ...
                case 0:
                    document.body.style.backgroundImage = "ulr(https://kaupalph.sirv.com/Imagens/imagens/03%20raios-chuva-clima-ao-vivo-tempo-alerta-previsao-1677503593653.jpgg)"
